                ...
                <div class="row mb-3 mx-3 bg-light shadow">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card border-0 h-100 p-3">
                            ...
                            @if ($order->status == 'Processing')
                            <a href="" class="btn btn-danger ms-auto">Batalkan Pesanan</a>
                            @else
                                @if ($order->status == 'Arrived')
                                <a href="" class="btn-btn-success ms-auto">Konfirmasi Sampai</a>
                                @else
                                    @if ($order->status == 'Confirmed')
                                        <a href="" class="btn btn-success ms-auto">Review</a>
                                    @endif
                                @endif
                            @endif
                        </div>
